	...
	if( $get_meta['tie_post_head'][0] == 'video' ){
		if( isset( $get_meta["tie_video_url"][0] ) && !empty( $get_meta["tie_video_url"][0] ) ){
			...
			if ( $video_link['host'] == 'www.youtube.com' || $video_link['host']  == 'youtube.com' ) {
				...
				$video_code ='<iframe width="'.$width.'" height="'.$height.'" src="https://www.youtube.com/embed/'.$video.'?rel=0&wmode=opaque" frameborder="0" allowfullscreen></iframe>';
			}
			elseif( $video_link['host'] == 'www.youtu.be' || $video_link['host']  == 'youtu.be' ){
				...
				$video_code='<iframe src="https://player.vimeo.com/video/'.$video.'?wmode=opaque" width="'.$width.'" height="'.$height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
			}
			elseif( $video_link['host'] == 'www.dailymotion.com' || $video_link['host']  == 'dailymotion.com' ){
				...
				$video_code='<iframe frameborder="0" width="'.$width.'" height="'.$height.'" src="https://www.dailymotion.com/embed/video/'.$video_id.'"></iframe>';
			}
		}
