...
class tie_video_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php elseif ( $youtube_video ):?>
			<iframe width="100%" height="210" src="https://www.youtube.com/embed/<?php echo $youtube_video ?>?rel=0&wmode=opaque" frameborder="0" allowfullscreen></iframe>
		<?php elseif ( $vimeo_video ):?>
			<iframe src="https://player.vimeo.com/video/<?php echo $vimeo_video ?>?wmode=opaque" width="100%" height="210" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
		<?php endif; ?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<small>if video url : https://www.youtube.com/watch?v=UjXi6X-moxE  Enter above <strong>UjXi6X-moxE</strong></small>
		</p>
		<em style="display:block; border-bottom:1px solid #CCC; margin-bottom:15px;">OR</em>
		<p>
			...
			<small>if video url : https://vimeo.com/6184227  Enter above <strong>6184227</strong></small>
		</p>
